    ...
    public render(): React.ReactNode {
        ...
        return (
            ...
            >
                <Container className='content-card '>
                    <Row>
                        ...
                        <Col className="p-2" lg="auto">
                            ...
                            {/* <Row className="small"> */}
                            <Col
                                className="me-2 d-flex align-items-center sub-text"
                                lg="auto"
                            >
                                <FontAwesomeIcon
                                    icon={faBookOpen}
                ...
                <Container className='content-card mt-2 bg-light'>
                    <Row>
                        <Col ></Col>
                        {this.state.playing ? (
                            <Col className="p-2" lg="auto">
